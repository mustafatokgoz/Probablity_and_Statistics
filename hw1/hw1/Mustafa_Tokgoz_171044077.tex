...
\begin{itemize}
	...
	\newline
	\newline
	 Hypothesis 1 : Diabetes prevalence causes coronavirus deaths
	 \newline
	 \newline
	  How did you obtain the hypothesis: There are two countries Tunisia and Algeria which have near variables like economic performance , handwashing facilities. But diabet prevalence of Tunisia is higher than Algeria's. Although the population of Tunisia is small than Agleria, the total death of Tunisia is  more than Algeria's because of diabet prevelance.
	  \newline
	  \newline
	  Hypothesis 2 : Rate of Smokers causes coronavirus deaths
	  \newline
	 \newline
     How did you obtain the hypothesis: There are two countries Albania and Algeria which have same female smoker rate but different male smoker. Albania has more rate of male smoker than Algeria. The death rate of Albania is greater than Albania. 
     \newline
	 \newline
	 System Requirements : Python3 , pandas and openpyxl libraries , input file that name is owid-covid-data.xlsx in same directory.
